...
<head>
  ...
  <title>CivicUtility v0.1.0</title>
  <style>
...
<main>
  ...
  <p>CivicUtility v0.1.0 helps CSRs answer cited billing-policy questions, view safe read-only account context, draft payment arrangements for review, and prepare service-request handoffs.</p>
  <section class="grid">
    ...
    <article class="card"><h2>Boundary</h2><p>No utility billing, payments, shutoff decisions, rate-engine behavior, live LLM calls, or billing-system write-back ships in v0.1.0.</p></article>
  </section>
  <section class="card" style="margin-top:24px">
    <h2>Architecture</h2>
    <p><strong>Resident / CSR request</strong> → CivicUtility deterministic API → CivicCore foundation. External billing and Civic311 integrations are read/handoff roadmap items, not v0.1.0 write paths.</p>
  </section>
  <p>Dependency: <code>civiccore==0.2.0</code>. Repo: <a href="https://github.com/CivicSuite/civicutility">CivicSuite/civicutility</a>.</p>
</main>
</body>
</html>
"""
